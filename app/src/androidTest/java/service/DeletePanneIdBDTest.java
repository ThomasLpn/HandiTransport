...
public class DeletePanneIdBDTest extends TestCase {
    ...
    public void testDeletePanneId() throws Exception {
        ...
        assertEquals(true, new DeletePanneIdBD().deletePanneId(listPost));
    }
}